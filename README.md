...
3. **Download the File**  
   Look for the download link labeled “Source code (zip)” or a similar package suitable for your operating system.
...
Once you run the application, it will ask you to select a dataset. Here’s how to use it:
...
- **Explore**: Don’t hesitate to try different classifiers and settings. It’s a great way to learn.
